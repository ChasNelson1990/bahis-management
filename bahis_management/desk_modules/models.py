...
class DeskModule(models.Model):
    ...
    list_definition_id = models.IntegerField(blank=True, null=True)  # TODO can we just use the form ID or URL for this?
    form_id = models.IntegerField(blank=True, null=True)  #  TODO how to import from kobo in bahis 3, as a URL?, also - how to handle offline forms?
    external_url = models.URLField(blank=True, null=True)  # TODO if this is also a URL can we simplify all three into one field?
