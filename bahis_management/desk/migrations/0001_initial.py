    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_form",
                    models.IntegerField(blank=True, help_text="The source form for this workflow", null=True),
                ),
                (
                    "destination_form",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(("external_url__isnull", True), ("form__isnull", True)),
                    models.Q(("external_url__isnull", True), ("form__isnull", False)),
                    models.Q(("external_url__isnull", False), ("form__isnull", True)),
                    _connector="OR",
                ),
